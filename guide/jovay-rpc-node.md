...
|--------------|-----------------|------------------|----------------------------------------------------------------------------------------|-------------------------------------|
| 2026.04.03   | 0.12.1          | 0.12.1-rc2       | jovay-release-registry.cn-hongkong.cr.aliyuncs.com/jovay/l2-rpc:0.12.1-rc1             | Fix an issue the RPC node could fork from the consensus node|
